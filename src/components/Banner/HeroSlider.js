...
const HeroSlider = () => {
    ...
    return (_jsxs("div", { className: "relative w-full overflow-hidden bg-gray-50 min-h-[480px] lg:min-h-[650px]", children: [_jsx("div", { className: "flex transition-transform duration-700 ease-in-out", style: {
