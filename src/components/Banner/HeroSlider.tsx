...
const HeroSlider = () => {
  ...
  useEffect(() => {
    if (isManuallyChanged) return; // 수동 조작 시 자동 전환 중단
  ...
  return (
    <div className="relative w-full overflow-hidden min-h-[500px] lg:min-h-[650px] bg-gray-50">
      <div
            ...
            <div className="relative w-full lg:w-3/4 h-[300px] sm:h-[360px] md:h-[400px] lg:h-full">
              ...
              >
                <img
                  src={banner.image}
                  alt={banner.title}
                  className="w-[90%)] h-full object-cover rounded-xl shadow-lg"
                />
              </a>
