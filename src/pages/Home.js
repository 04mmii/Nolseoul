...
const Home = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(Header, {}), _jsx(HeroSlider, {}), _jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [_jsxs("section", { className: "my-12", children: [_jsx("h2", { className: "text-3xl font-bold mb-8 text-center", children: "\uD604\uC7AC \uC9C4\uD589 \uC911\uC778 \uD589\uC0AC" }), (ongoingEvents === null || ongoingEvents === void 0 ? void 0 : ongoingEvents.length) > 0 ? (_jsx(OngoingEventSlider, { events: ongoingEvents })) : (_jsx("p", { className: "text-gray-500", children: "\uD604\uC7AC \uC9C4\uD589 \uC911\uC778 \uBB38\uD654 \uD589\uC0AC\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4." }))] }), _jsxs("section", { className: "my-16", children: [_jsxs("div", { className: "mb-8 text-center", children: [_jsxs("h2", { className: "text-3xl font-bold ", children: [today.month() + 1, "\uC6D4 \uBB38\uD654 \uD589\uC0AC"] }), _jsx(Link, { to: "/events", className: "block text-blue-600 hover:text-blue-800 transition-colors", children: "\uB354\uBCF4\uAE30 \u2192" })] }), _jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6", children: (currentMonthEvents === null || currentMonthEvents === void 0 ? void 0 : currentMonthEvents.length) > 0 ? (currentMonthEvents.map((event) => (_jsx(EventCard, { event: event }, event.CULTCODE)))) : (_jsxs("p", { className: "text-gray-500 col-span-full", children: [today.month() + 1, "\uC6D4\uC5D0 \uC608\uC815\uB41C \uBB38\uD654 \uD589\uC0AC\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4."] })) })] }), _jsxs("section", { className: "my-16", children: [_jsxs("div", { className: "mb-8 text-center", children: [_jsx("h2", { className: "text-3xl font-bold", children: "\uCD94\uCC9C \uBB38\uD654\uACF5\uAC04" }), _jsx(Link, { to: "/spaces", className: "block text-navy-600 hover:text-navy-800 transition-colors", children: "\uB354\uBCF4\uAE30 \u2192" })] }), _jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6", children: spaces === null || spaces === void 0 ? void 0 : spaces.slice(0, 5).map((space) => (_jsx(CulturalSpaceCard, { space: space }, space.NUM))) })] })] }), _jsx(Footer, {})] }));
};
export default Home;
