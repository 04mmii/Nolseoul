      ...
      _jsxs("main", {
        ...
        children: [
          _jsx("div", {
            ...
            children: _jsxs("div", {
              className:
                "absolute inset-0 bg-black bg-opacity-40 flex flex-col justify-center items-center text-center px-4",
              children: [
                _jsx("h1", {
          ...
          _jsxs("div", {
            className: "max-w-7xl mx-auto px-4 mt-8 space-y-6",
            children: [
              _jsx(FilterTabs, {
                ...
                children: [
                  _jsx("input", {
                    ...
                    placeholder:
                      "\uD589\uC0AC\uBA85\uC744 \uAC80\uC0C9\uD558\uC138\uC694",
                    className:
                      "w-full p-3 pl-10 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500",
                    value: searchQuery,
              ...
              paginatedEvents.length > 0
                ? _jsx("div", {
                    ...
                    children: paginatedEvents.map((event, i) =>
                      _jsx(EventCard, { event: event }, i)
                    ),
                  })
                : _jsx("p", {
