...
function App() {
    return (_jsxs("div", { className: "font-noto", children: [_jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(Home, {}) }), _jsx(Route, { path: "/events/:slug", element: _jsx(EventsPage, {}) }), _jsx(Route, { path: "/events", element: _jsx(EventsPage, {}) }), _jsx(Route, { path: "/spaces", element: _jsx(CulturalSpacesPage, {}) }), _jsx(Route, { path: "/spaces/:NUM", element: _jsx(CulturalSpaceDetail, {}) }), _jsx(Route, { path: "/night-views", element: _jsx(NightViewsPage, {}) })] }), _jsx(SpeedInsights, {})] }));
}
export default App;
